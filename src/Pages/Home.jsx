      ...
      <main className="min-h-screen  overflow-x-hidden">
        <section className="flex flex-col items-center justify-center px-6 py-10 text-center md:py-23 bg-[#f9fafb] relative overflow-x-hidden">
          <motion.div initial="hidden" animate="visible" variants={fadeInUp}>
            ...
            <h1 className="text-5xl font-extrabold tracking-tight text-gray-700 md:text-6xl">
              ...
              <span className="text-transparent bg-clip-text bg-gray-700 block whitespace-nowrap">
            ...
            <div className=" absolute top-1/2 left-0 right-0 flex justify-between w-full px-4 md:px-5 lg:px-20 transform -translate-y-1/2 pointer-events-none">
              {/* Left Component */}
              <FloatingCircle
                side="left"
                label="NEPAL"
                icon={
                  <img
                    src="https://icon2.cleanpng.com/20180421/kow/avuw2zdpg.webp"
                    className="w-6"
                    alt="Nepal"
                  />
                }
        ...
        <section className="bg-gray-50 py-10 px-4 ">
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="px-6 py-5 text-sm font-semibold text-white bg-[#1e293b] rounded-xl shadow-lg text-center mx-auto  block transition-all "
          >
