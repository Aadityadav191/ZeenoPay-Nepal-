...
export default function Cards({ title, content, image }) {
  return (
    <>
      <div className="relative flex w-90 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md hover:cursor-pointer mb-5 ">
